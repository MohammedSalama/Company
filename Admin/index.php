  ...
  <body>
    <div class="be-wrapper be-fixed-sidebar">
        ...
        <div class="container-fluid">
          ...
          <div class="be-right-navbar">
            <ul class="nav navbar-nav navbar-right be-user-nav">
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="assets/img/avatar.png" alt="Avatar"><span class="user-name">WELCOME ADMIN</span></a>
      ...
      <div class="be-left-sidebar">
        <div class="left-sidebar-wrapper"><a href="index.php" class="left-sidebar-toggle">Dashboard</a>
